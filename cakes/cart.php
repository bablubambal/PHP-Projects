...
if(isset($_POST['update_qty'])){
   ...
   $update_qty = $conn->prepare("UPDATE `cart` SET quantity = ? , customization = ?  WHERE id = ?");
   $update_qty->execute([$qty,$customization, $cart_id],);
...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex" style="flex-direction:column; width:100%;">
         ...
         <input type="text" name="customization" class=" w-100"   value="<?= $fetch_cart['customization']; ?>" placeholder="Your customization here...">
