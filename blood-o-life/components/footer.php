<footer class="footer">
   ...
   <div class="credit">
   <p class="fs-1"><img src="https://cdn-icons-png.flaticon.com/512/46/46045.png" style="width:50px" alt="">   
      Tutor <span class="text-bold">Care..</span></a></p>
      &copy; copyright @ <?= date('Y'); ?> by Tutor Care.. </div>
