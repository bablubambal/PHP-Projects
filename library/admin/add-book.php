...
// allowed extensions
$allowed_extensions = array(".jpg","jpeg",".png",".gif",".docx",".pdf");
...
move_uploaded_file($_FILES["bookPdf"]["tmp_name"],"bookimg/".$bookPdf);
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,bookPdf) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:bookPdf)";
...
{               ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Book (Digital Copy)<span style="color:red;">*</span></label>
                                        <input class="form-control" type="file" name="bookPdf" autocomplete="off"
                                            required="required" />
                                    </div>
                                </div>
