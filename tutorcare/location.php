...
<section class="products ">
   ...
   <h1 class="heading">Tutor's by Location:</h1>

   <div class="">

   <?php
     $category = $_GET['category'];
     $select_products = $conn->prepare("SELECT * FROM `users` WHERE location LIKE '%{$category}%'"); 
      ...
      <div class="col-md-12 col-xl-4">
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body text-center">
            <div class="mt-3 mb-4">
              <img src="uploaded_img/<?= $fetch_product['profileimg']; ?>" class="rounded img-fluid" style="width: 350px;" />
            </div>
            ...
            <button type="button" class="btn btn-success btn-rounded btn-lg mx-2">
   ...
   <?php
      ...
      echo '<p class=" empty text-white border-danger bg-danger">Tutor of That subject Not yet registered At this location</p>';
   }
   ?>
